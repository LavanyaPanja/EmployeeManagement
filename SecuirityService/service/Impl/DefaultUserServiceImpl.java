...
import com.employeeManagement.securityService.entity.Role;
import com.employeeManagement.securityService.entity.User;
import com.employeeManagement.securityService.repository.RoleRepository;
...
public class DefaultUserServiceImpl implements DefaultUserService{
    ...
    public User save(UserDTO userRegisteredDTO) {
        Role role = new Role();
        if(userRegisteredDTO.getRole().equals("MANAGER"))
            role = roleRepo.findByRole("ROLE_MANAGER");
        else if(userRegisteredDTO.getRole().equals("ADMIN"))
            role = roleRepo.findByRole("ROLE_ADMIN");
        else if(userRegisteredDTO.getRole().equals("USER"))
            role = roleRepo.findByRole("ROLE_USER");
        else if(userRegisteredDTO.getRole().equals("HR"))
            role = roleRepo.findByRole("ROLE_HR");
        User user = new User();
