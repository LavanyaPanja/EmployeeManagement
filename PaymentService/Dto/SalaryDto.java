...
public class SalaryDto {
    ...
    public SalaryDto(long empId, String empName, String bankName,long accountNumber,long monthAmount, LocalDateTime paymentDate,long totalExpensesAmount,long totalAmount) {
        this.empId = empId;
