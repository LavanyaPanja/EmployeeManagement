package com.employeeManagement.expensesService.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> resourceNotFoundExceptionHandler(ResourceNotFoundException ex){
        return new ResponseEntity<>("EXPENSES NOT FOUND", HttpStatus.NOT_FOUND);
    }
    @ExceptionHandler(DuplicateUsernameException.class)
    public ResponseEntity<Object> sqlIntegrityConstraintViolationException(DuplicateUsernameException ex){
        return new ResponseEntity<>("Duplicate Entry For Expenses", HttpStatus.ALREADY_REPORTED);
    }
    ...
    public ResponseEntity<Object> AlreadyRejectedExceptionHandler(AlreadyRejectedException ex){
        return new ResponseEntity<>("Already Rejected Exception", HttpStatus.ALREADY_REPORTED);
    }
}
